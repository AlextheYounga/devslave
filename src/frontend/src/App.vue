                                ...
                                <nav class="relative flex flex-1 flex-col">
                                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                        ...
                                        <li class="-mx-6 mt-auto">
                                            ...
                                            >
                                                <img
                                                    class="size-8 rounded-full bg-gray-800 outline-1 -outline-offset-1 outline-white/10"
            ...
            <main>
                ...
                <div class="border-t border-white/10 pt-11">
                    ...
                    <table class="mt-6 w-full whitespace-nowrap text-left">
                        ...
                        <thead
                            class="border-b border-white/10 text-xs font-semibold uppercase tracking-wide text-gray-400"
                        >
                            <tr>
