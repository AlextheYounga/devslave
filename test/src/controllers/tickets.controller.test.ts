...
const ScanTicketsHandlerMock =
  ScanTicketsHandler as jest.MockedClass<typeof ScanTicketsHandler>;
...
describe("TicketsController", () => {
  ...
  beforeEach(() => {
    ...
    ScanTicketsHandlerMock.mockImplementation(() => ({ handle: scanHandle }) as any);
  });
